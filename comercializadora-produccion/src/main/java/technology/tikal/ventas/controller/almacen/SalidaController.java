...
public interface SalidaController {
    ...
    Salida crear(Long pedidoId, RegistroAlmacenTransient request);

    void actualizar(Long pedidoId, Long registroId, RegistroAlmacenTransient request);

    Salida[] consultar(Long pedidoId, RegistroAlmacenFilter filter, PaginationDataLong pagination);

    Salida get(Long pedidoId, Long registroId);
