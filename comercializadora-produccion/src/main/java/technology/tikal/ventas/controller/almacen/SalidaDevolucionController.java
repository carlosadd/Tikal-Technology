 ...
 *
 */
public interface SalidaDevolucionController {

    SalidaDevolucion crear(Long pedidoId, RegistroAlmacenTransient request);

    void actualizar(Long pedidoId, Long registroId, RegistroAlmacenTransient request);

    SalidaDevolucion[] consultar(Long pedidoId, RegistroAlmacenFilter filter, PaginationDataLong pagination);

    SalidaDevolucion get(Long pedidoId, Long registroId);
