 ...
 *
 */
public class ProductoIntermediarioCacheController extends AbstractCacheController<ProductoIntermediario> {

    @Override
    public boolean haveChanges(UpdatePair<ProductoIntermediario> pair) {
    ...
    public boolean isTypeOf(Object retVal) {
        return retVal instanceof ProductoIntermediario;
    }

    @Override
    public UpdatePair<ProductoIntermediario> cloneObject(Object retVal) {
        ProductoIntermediario objA = (ProductoIntermediario) retVal;
        ProductoIntermediario objB = ProductoFactory.clone(objA);
        return new UpdatePair<ProductoIntermediario>(objB, objA);
    }
