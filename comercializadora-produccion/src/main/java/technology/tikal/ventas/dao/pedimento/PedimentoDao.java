 ...
 */
package technology.tikal.ventas.dao.pedimento;
 ...
 *
 */
public interface PedimentoDao extends ChildEntityDAO<PedimentoOfy, Long, Pedido, PedimentoFilter, PaginationData<Long>> {
