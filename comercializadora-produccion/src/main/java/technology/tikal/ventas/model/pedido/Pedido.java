 ...
 */
@JsonSubTypes({
    @JsonSubTypes.Type(value = PedidoIntermediario.class),
    @JsonSubTypes.Type(value = PedidoCompuestoIntermediario.class),
    @JsonSubTypes.Type(value = SubPedidoIntermediario.class)
})
