 ...
 */
@JsonSubTypes({
    @JsonSubTypes.Type(value = PedimentoIntermediario.class),
    @JsonSubTypes.Type(value = PedimentoIntermediarioTransient.class),
    @JsonSubTypes.Type(value = GrupoPedimento.class)
})
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type")
public interface Pedimento {
