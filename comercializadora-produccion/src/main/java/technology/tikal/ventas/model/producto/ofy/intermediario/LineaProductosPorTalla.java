 ...
 */
@Subclass(index=true)
@JsonTypeName("LineaProductosPorTalla")
public class LineaProductosPorTalla extends LineaDeProductosOfy {

    @NotNull
    @Valid
    private DatosGenerales datosGenerales;
    
    protected LineaProductosPorTalla() {
        super();
        this.datosGenerales = new DatosGenerales();
    }
    public LineaProductosPorTalla(Catalogo owner) {
        super(owner);
        this.datosGenerales = new DatosGenerales();
    }
    public LineaProductosPorTalla(LineaProductosPorTalla base) {
        super(base);
        this.datosGenerales = new DatosGenerales();
    }
