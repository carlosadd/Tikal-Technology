 ...
 */
@RestController
@RequestMapping("/pedido/{pedidoId}/almacen/salida")
public class SalidaService extends RestControllerTemplate {
    ...
    public Page<Salida[]> consultar(@PathVariable final Long pedidoId,
        ...
        Page<Salida[]> r = PaginationModelFactory.getPage(
                salidaController.consultar(pedidoId, filter, pagination),
                "Entrada",
    ...
    public Salida get(@PathVariable final Long pedidoId, @PathVariable final Long registroId) {
        return salidaController.get(pedidoId, registroId);
    }
    ...
    public void borrar(@PathVariable final Long pedidoId, @PathVariable final Long registroId) {
        salidaController.borrar(pedidoId, registroId);
    }
