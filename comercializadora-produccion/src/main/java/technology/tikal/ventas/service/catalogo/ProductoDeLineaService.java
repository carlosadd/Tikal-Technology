 ...
 */
@RestController
@RequestMapping("/catalogo/producto/{idCatalogo}/lineaProducto/{lineaProductoId}/productos")
public class ProductoDeLineaService extends RestControllerTemplate {
    ...
    public void actualizar(@PathVariable final Long idCatalogo, @PathVariable final Long lineaProductoId,
        @PathVariable final Long productoId, @Valid @RequestBody final ProductoDeLinea request, final BindingResult result) {
        if (result.hasErrors()) {
            throw new NotValidException(result);
        }
    ...
    public Page<ProductoDeLinea[]> consultar(@PathVariable final Long idCatalogo, @PathVariable final Long lineaProductoId,
        ...
        Page<ProductoDeLinea[]> r = PaginationModelFactory.getPage(
                productoDeLineaController.consultar(idCatalogo, lineaProductoId, pagination),
                "Pedido",
    ...
    public ProductoDeLinea get(@PathVariable final Long idCatalogo, @PathVariable final Long lineaProductoId,
            @PathVariable final Long productoId) {
        return productoDeLineaController.cargar(idCatalogo, lineaProductoId, productoId);
    }
    ...
    public void delete(@PathVariable final Long idCatalogo, @PathVariable final Long lineaProductoId,
            @PathVariable final Long productoId) {
        productoDeLineaController.borrar(idCatalogo, lineaProductoId, productoId);
    }
