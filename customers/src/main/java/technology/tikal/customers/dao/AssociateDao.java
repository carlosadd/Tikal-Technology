 ...
 */
package technology.tikal.customers.dao;
...
/**
 * @author Nekorp
 * no se usa por el costo en indices
 *
 */
@Deprecated
public interface AssociateDao extends ChildEntityDAO<AssociateOfy, Long, CustomerOfy, ContactFilter, PaginationDataDual<Long, String>> {
