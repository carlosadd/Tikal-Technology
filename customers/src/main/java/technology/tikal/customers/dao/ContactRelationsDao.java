 ...
 *
 */
public interface ContactRelationsDao extends ChildEntityDAO<ContactRelationshipOfy, Long, ContactOfy, ContactRelationshipFilter, PaginationDataDual<Long, String>>{
