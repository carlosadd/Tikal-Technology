 ...
 *
 */
public class SmallPrimaryContactProxy implements PrimaryContact, ContactProxy {

    @JsonIgnore
    private PrimaryContact delegate;
    
    public SmallPrimaryContactProxy (PrimaryContact delegate) {
