 ...
 */
package technology.tikal.gae.http.cache.dao;
 ...
 *
 */
public interface UriEtagEntryDao extends EntityDAO<UriEtagEntry, String, FiltroBusqueda, PaginationData<String>>{
